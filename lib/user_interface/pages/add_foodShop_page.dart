...
class AddFoodShopsPage extends StatefulWidget {
  @override
  _AddFoodShopsPageState createState() => _AddFoodShopsPageState();
}

class _AddFoodShopsPageState extends State<AddFoodShopsPage> {
