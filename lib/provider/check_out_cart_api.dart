...
class ApiCheckOutCart extends ApiProvider {
  ApiCheckOutCart(BuildContext context) : super(context);

  Future<WebServiceResponse> checkOut(var body) async {

    dynamic response = await fetchRequest(
        uri: getUri(ApiConstants.checkOutCart,body), type: RequestType.post);
